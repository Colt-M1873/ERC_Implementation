...
| Author         | [William Entriken](https://github.com/fulldecent), [Dieter Shirley](mailto:dete@axiomzen.co), [Jacob Evans](mailto:jacob@dekz.net), [Nastassia Sachs](mailto:nastassia.sachs@protonmail.com) |
| -------------- | ------------------------------------------------------------ |
...
- [Simple Summary](https://eips.ethereum.org/EIPS/eip-721#simple-summary)
- [Abstract](https://eips.ethereum.org/EIPS/eip-721#abstract)
- [Motivation](https://eips.ethereum.org/EIPS/eip-721#motivation)
- Specification
  - [Caveats](https://eips.ethereum.org/EIPS/eip-721#caveats)
- [Rationale](https://eips.ethereum.org/EIPS/eip-721#rationale)
- [Backwards Compatibility](https://eips.ethereum.org/EIPS/eip-721#backwards-compatibility)
